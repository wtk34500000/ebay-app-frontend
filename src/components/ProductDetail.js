    ...
    return (
        <div className="product-container">
            ...
            <div className="home-page">
                <Link to='/welcome'><span>Back to Home Page</span></Link>
            </div>
            ...
            <div id="product-item">
                ...
                <div className="product-info">
                    ...
                    <div className="wish-button"> 
                            <button onClick={addToWishListHandler}><i className="far fa-heart" style={{color: "red"}}></i> Add to Wish list</button>
                    </div>
                </div>
            </div>
